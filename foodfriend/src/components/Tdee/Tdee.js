...
class Tdee extends Component {
  ...
  handleSubmit = event => {
    ...
    const bmr = CalorieCalc.MifflinStJeor(
      this.state.sex,
      ...
      <div className="container-960">
        ...
        <div className="row">
          <div className="col-sm-12">
            <h2>Next Steps</h2>
            <p>
              If you are looking to gain or lose weight, you need to know that a
              pound of fat is about 3,500 calories. Most people are going to
              lose or gain that weight at a rate of about 1 lb a week. That
              works out to 500 calories a day (500 x 7 = 3500). So take your
              TDEE and subtract 500 from it to lose weight and add 500 to gain
              weight.
            </p>
          </div>
        </div>
